...
def select_1():
    ...
    print ("\x1b[1;91m[\x1b[1;92m02\x1b[1;91m]\x1b[1;97m CREATE FILE (NEW METHOD)");time.sleep(0.1)
    print ("\x1b[1;91m[\x1b[1;92m03\x1b[1;91m]\x1b[1;97m BUY SUBSCRIPTION");time.sleep(0.1)
...
def file_menu():
	...
	mo = raw_input('SELECT : ')
        if mo == ('1'):
          ...
          os.system('cd xxx && python2 Prohack.py')
        elif mo == ('BA'):
          select_1()
        elif mo == ('EX'):
    	  os.system('exit')
